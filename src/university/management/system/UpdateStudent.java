...
public class UpdateStudent extends JInternalFrame {
    ...
    private JLabel labelName, labelFatherName, labelRollNo, labelDob, labelMarks10, labelMarks12, labelAadhar;
    private JButton updateButton, cancelButton;
    private JComboBox<String> rollNoComboBox;

    public UpdateStudent() {
        // 'super' call is required for JInternalFrame
        super("Update Student Details", true, true, true, true);
        ...
        add(new JLabel("Select Roll Number:"), gbc);
        rollNoComboBox = new JComboBox<>();
        gbc.gridx = 1; gbc.anchor = GridBagConstraints.WEST;
        add(rollNoComboBox, gbc);
        ...
        gbc.gridx = 0; gbc.gridy = 3; gbc.anchor = GridBagConstraints.LINE_END; add(new JLabel("Roll Number:"), gbc);
        labelRollNo = new JLabel(); gbc.gridx = 1; gbc.anchor = GridBagConstraints.LINE_START; add(labelRollNo, gbc);
        ...
        gbc.gridx = 0; gbc.gridy = 7; gbc.anchor = GridBagConstraints.LINE_END; add(new JLabel("Course:"), gbc);
        textCourse = new JTextField(15); gbc.gridx = 1; gbc.anchor = GridBagConstraints.LINE_START; add(textCourse, gbc);

        gbc.gridx = 2; gbc.gridy = 7; gbc.anchor = GridBagConstraints.LINE_END; add(new JLabel("Branch:"), gbc);
    ...
    private void performUpdate() {
        ...
        try (ConnectionForSystem c = new ConnectionForSystem();
            ...
            pstmt.setString(6, labelRollNo.getText());
            ...
            if (affectedRows > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Update failed. Student not found.", "Update Error", JOptionPane.ERROR_MESSAGE);
            }
