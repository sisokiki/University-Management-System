...
public class StudentLeave extends JInternalFrame {
    ...
    public StudentLeave() {
        ...
        super("Apply Student Leave", true, true, true, true);
        ...
        gbc.gridx = 0; gbc.gridy = 1; add(new JLabel("Select Roll Number:"), gbc);
        rollNoComboBox = new JComboBox<>();
        gbc.gridx = 1; gbc.gridy = 1; add(rollNoComboBox, gbc);
    ...
    private void performSubmit() {
        ...
        String query = "INSERT INTO studentLeave VALUES(?, ?, ?)";
        try (ConnectionForSystem c = new ConnectionForSystem();
